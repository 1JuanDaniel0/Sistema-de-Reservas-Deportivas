...
@Repository
public interface ReservaRepositoryVecino extends JpaRepository<Reserva, Integer> {
    List<Reserva> findByEspacio_IdEspacioAndFecha(int idEspacio, LocalDate fecha);
    List<Reserva> findByVecino_IdUsuariosOrderByMomentoReservaDesc(int idUsuario);
    List<Reserva> findByVecino_IdUsuariosAndEstado_IdEstadoReservaOrderByMomentoReservaDesc(int idUsuario, int idEstado);
    List<Reserva> findByEstado_IdEstadoReservaIn(List<Integer> estados);
    List<Reserva> findByVecino_IdUsuariosAndEstado_IdEstadoReservaIn(int idUsuario, List<Integer> estados);
    ...
    long countByCoordinadorAndEstado_EstadoAndFechaPagoBetween(
    ...
    @Query("SELECT r FROM Reserva r WHERE r.coordinador = :coordinador " +
            "AND r.estado.estado = 'Pendiente de confirmación' " +
    ...
    List<Reserva> findByCoordinador_IdUsuarios(Integer coordinador);
}
